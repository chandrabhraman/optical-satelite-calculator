        ...
        <Tabs defaultValue="basic" onValueChange={handleTabChange}>
          ...
          <TabsContent value="geometry" className="space-y-6">
            <div className="prose max-w-none dark:prose-invert">
              ...
              <h3 className="text-lg font-semibold mt-6">Horizontal Footprint (Swath)</h3>
              <p className="text-muted-foreground mb-2">Width of the sensor's footprint on Earth, accounting for curvature.</p>
              <div className="bg-muted/50 p-4 rounded-md">
